...
export const navItems = [
    {title: 'Home', route: 'home', tag:<Home />}, 
    {title: 'About me', route: 'about_me', tag:<AboutMe />},
    {title: 'Star Wars', route: 'star_wars', tag:<StarWars />},
    {title: 'Contact', route: 'contact', tag:<Contact />}
];
